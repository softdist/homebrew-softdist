class SoftdistRelease < Formula
  ...
  # Variable to store downloaded binary name
  def initialize(*)
    super
    @run_binary = nil
  end
  ...
  on_macos do
    if Hardware::CPU.intel?
      ...
      def initialize(*); super; @run_binary = "sd-run-darwin-amd64"; end
      ...
      def initialize(*); super; @run_binary = "sd-run-darwin-arm64"; end
    end
  end
  ...
  on_linux do
    if Hardware::CPU.intel?
      ...
      def initialize(*); super; @run_binary = "sd-run-linux-amd64"; end
    elsif Hardware::CPU.arm?
      ...
      def initialize(*); super; @run_binary = "sd-run-linux-arm64"; end
    end
  end
  ...
  resource "sd-install" do
    on_macos do
      if Hardware::CPU.intel?
        ...
        def initialize(*); super; @run_binary = "sd-install-darwin-amd64"; end
      elsif Hardware::CPU.arm?
    ...
    on_linux do
      if Hardware::CPU.intel?
        ...
        def initialize(*); super; @run_binary = "sd-install-linux-amd64"; end
      elsif Hardware::CPU.arm?
        ...
        def initialize(*); super; @run_binary = "sd-install-linux-arm64"; end
      end
    end
  end
  ...
  resource "sd-extricate" do
    on_macos do
      if Hardware::CPU.intel?
        ...
        def initialize(*); super; @run_binary = "sd-extricate-darwin-amd64"; end
      elsif Hardware::CPU.arm?
        ...
        def initialize(*); super; @run_binary = "sd-extricate-darwin-arm64"; end
      end
    end
    ...
    on_linux do
      if Hardware::CPU.intel?
        ...
        def initialize(*); super; @run_binary = "sd-extricate-linux-amd64"; end
      elsif Hardware::CPU.arm?
        ...
        def initialize(*); super; @run_binary = "sd-extricate-linux-arm64"; end
      end
    end
  end
  ...
  def install
    # Install main binary properly
    bin.install @run_binary => "sd-run"
